...
class StudentRegisterForm(forms.Form):
    fullname = forms.CharField(
        label='Nama', label_suffix=" : ", required=True, widget=forms.TextInput( attrs={'class': 'form-control', 'placeholder': 'John Smith'}),        help_text="Nama lengkap mahasiswa", error_messages={'required': "Harus Diisi"})
    nim = forms.CharField(
